# Restored VM Machine Image Build and Promotion Pipeline

The machine image build/promote pipeline was broken, blocking releases and forcing operators to manually push images across environments.
